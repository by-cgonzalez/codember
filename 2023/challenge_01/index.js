...
const decifraPatron = (message) => {
    ...
    return Object.entries(reduceMsg)
      .flat()
      .join()
      .replaceAll(',','')
  }

 console.log(decifraPatron(patron));